...
async function calc(){
    if(!img){
        ...
        img = await loadImage("gundam_low.png");
        can.width = img.width;
        ...
        if(true){
            ...
            for(let y = 0; y < can.height; y++){
                for(let x = 0; x < can.width; x++){
                    ...
                    // tx = Math.floor((dx|dist+10)*dist/rr);
                    // ty = Math.floor((dy/dist)*dist+can.height/2);
                    let ind = Math.floor((tx+ty*can.width)*4/4000<<rr);
                    // let ind = Math.floor((tx*ty*can.width/rr)*4/4000/10); // crazy
                    // let ind = Math.floor((tx+ty*can.width)*4/4000/rr); // crazy
                    // let ind = Math.floor((tx+ty*can.width)*4/2000/rr+50000); // weird white color
                    // let ind = Math.floor((tx+ty*can.width)*4/200/(rr**2)+1000);
