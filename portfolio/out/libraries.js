function initCanExample() {
    const can = document.querySelector("#can_example");
...
function initCanControl() {
    let color = document.querySelector("#i-color");
    let color2 = document.querySelector("#i-color2");
    let color3 = document.querySelector("#i-color3");
    const can = document.querySelector("#can_control");
    can.width = 70;
    can.height = 50;
    const ctx = can.getContext("2d");
    const nob = new NobsinCtx(ctx);
...
function initCanDepth() {
    const can = document.querySelector("#can_depth");
    can.width = 120;
    can.height = 60;
    const ctx = can.getContext("2d");
    const nob = new NobsinCtx(ctx);
